...
class LoginResponse(BaseModel):
    ...
    access_token: Optional[str] = Field(None, description="The JWT access token if authentication was successful.")
    token_type: Optional[str] = Field(None, description="The type of the token (e.g., 'bearer').")
